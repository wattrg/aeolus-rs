...
pub fn triangle_area(vertices: &Vec<&Vertex>) -> Number  {
...
pub fn quad_area(vertices: &Vec<&Vertex>) -> Number {
...
pub fn compute_centre_of_vertices(vertices: &Vec<&Vertex>) -> Vector3 {
